...
<div class="wrapper">
	...
	<div class="content-wrapper" style="padding-top: 50px;">
	    ...
	    <section class="content-header">
	      <h1>
	        Add Unit
	        <small>> Add unit in database</small>
	      </h1>
	      <ol class="breadcrumb">
		            ...
		            <form class="form-horizontal" action="../controller/admin/addunit.php" method="post">
		              <div class="box-body">
		                <div class="form-group">
		                  ...
		                  <div class="col-md-6">
		                    <input type="text" class="form-control" id="unitid" name="unitid" placeholder="TFC, TFS, TFK, etc." required>
		                  </div>
		                </div>
		                ...
		                <div class="form-group">
		                  ...
		                  <div class="col-md-6">
		                    <input type="text" class="form-control" id="unitdesc" name="unitdesc" placeholder=" Unit TFC, Unit TFS,etc." required>
		                  </div>
		                </div>
